    ...
    <nav class="bg-primary-800 text-white shadow-lg" x-data="{ mobileMenu: false }">
        <div class="max-w-7xl mx-auto px-4 py-3">
            <div class="flex items-center justify-between">
                ...
                <div class="hidden md:flex items-center gap-1">
                    ...
                    <a href="{{ route('admin.kasir.create') }}"
                       class="px-3 py-2 rounded-lg text-sm font-medium transition flex items-center gap-1.5
                              {{ request()->routeIs('admin.kasir*') || (request()->routeIs('admin.orders*') && !request()->routeIs('admin.orders.today')) ? 'bg-primary-700 text-white shadow-sm' : 'text-primary-200 hover:bg-primary-700/50 hover:text-white' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.orders.trash') }}"
                       class="px-3 py-2 rounded text-sm font-medium transition flex items-center gap-1.5
                              {{ request()->routeIs('admin.orders.trash') ? 'bg-primary-700 text-white' : 'text-primary-200 hover:bg-primary-800 hover:text-white' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    @else
                    <a href="{{ route('admin.kasir.daily-report') }}"
                       class="px-3 py-2 rounded-lg text-sm font-medium transition flex items-center gap-1.5
                              {{ request()->routeIs('admin.kasir.daily-report') ? 'bg-primary-700 text-white shadow-sm' : 'text-primary-200 hover:bg-primary-700/50 hover:text-white' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                        </svg>
                        Laporan Harian
            ...
            <div x-show="mobileMenu" x-transition:enter="transition ease-out duration-200"
                ...
                <a href="{{ route('admin.kasir.create') }}"
                   class="block px-3 py-2.5 rounded-lg text-sm font-medium transition flex items-center gap-2
                          {{ request()->routeIs('admin.kasir*') || (request()->routeIs('admin.orders*') && !request()->routeIs('admin.orders.today')) ? 'bg-primary-700 text-white' : 'text-primary-200 hover:bg-primary-700/50 hover:text-white' }}">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                    </svg>
                    Pesanan
                ...
                @if(auth()->user()?->role === 'owner')
                <a href="{{ route('admin.orders.trash') }}"
                   class="block px-3 py-2.5 rounded text-sm font-medium transition flex items-center gap-2
                          {{ request()->routeIs('admin.orders.trash') ? 'bg-primary-700 text-white' : 'text-primary-200 hover:bg-primary-800 hover:text-white' }}">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/>
                    </svg>
                ...
                <a href="{{ route('admin.kasir.daily-report') }}"
                   class="block px-3 py-2.5 rounded-lg text-sm font-medium transition flex items-center gap-2
                          {{ request()->routeIs('admin.kasir.daily-report') ? 'bg-primary-700 text-white' : 'text-primary-200 hover:bg-primary-700/50 hover:text-white' }}">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                    </svg>
                    Laporan Harian

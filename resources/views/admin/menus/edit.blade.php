...
<div class="max-w-xl">
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
        <form action="{{ route('admin.menus.update', $menu) }}" method="POST" enctype="multipart/form-data" class="space-y-4" x-data="menuForm()">
            @csrf @method('PUT')
...
function menuForm() {
    return {
        imagePreview: {{ $menu->image ? "'" . asset('storage/' . $menu->image) . "'" : 'null' }},
